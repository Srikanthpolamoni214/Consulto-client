...
formData.append('fees', doctorDetails.fees.toString());
formData.append('experience', doctorDetails.experience.toString());
formData.append('avaliable', doctorDetails.avaliable ? "true" : "false");
formData.append('avaliableslots', JSON.stringify([doctorDetails.avaliableslots]))
